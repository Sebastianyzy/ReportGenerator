...
def main():
    ...
    report_file_name = "TSWIndividualAgeingReport.xlsx"
    ...
    Report.generate_aging_report_ind(report_file_name, wb, sheet, CUSTOMERS,
                                     customerJsonPath, AGED_RECEIVABLES_SUMMARY, output_file_row_num, text_style, 11, 30)
